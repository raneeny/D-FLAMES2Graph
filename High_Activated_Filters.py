...
class HighlyActivated:
    ...
    def Activated_filters(self,example_id):
        ...
        activated_nodes = activations[3]
        print("activations 1")
        print(activated_nodes.shape)
        activated_nodes = activations[6]
        print("activations 2")
        print(activated_nodes.shape)
        activated_nodes = activations[9]
        print("activations 3")
        print(activated_nodes.shape)
        #shows the activated filters for each layer for an example
        """
        print("the distrubution of all neurons")
        fig1, ax1 = plt.subplots()
        ax1.set_title('1')
        activated_nodes = activations[3]
        ax1.boxplot(activated_nodes[:, :, 0])
        plt.show()
        ####
        fig2, ax2 = plt.subplots()
        ax2.set_title('2')
        activated_nodes = activations[6]
        ax2.boxplot(activated_nodes[:, :, 0])
        plt.show()
        #####
        fig3, ax3 = plt.subplots()
        ax3.set_title('3')
        activated_nodes = activations[9]
        ax3.boxplot(activated_nodes[:, :, 0])
        plt.show()
        """
        #########
        return activations    
    ...
    def fitted_cluster(self,data,cluster):
        ...
        #print(f' cluster value {cluster[0]}')
    ...
    def get_graph_MHAP(self,activations,kernal_size,cluster_central,global_graph,threshoulds,n,sgmant_lenth):
        kernal_size = [8,5,3]
